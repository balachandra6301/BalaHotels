...
if(isset($_POST['submit']))
{
   ...
   $ins_qry=$conn->query("insert into guest_users(name,email,phone_number,message) values('$name','$email','$phonenumber','$message')");
   if($ins_qry)
   {
               ...
               <div class="col-md-6 padding_0">
                  <div class="mail_section">
                     <div class="email_text">
                        ...
                        <div class="form-group">
                           <input type="text" class="email-bt" placeholder="Phone Numbar" name="phonenumber" required>
                        </div>
                        <div class="form-group">
                           <textarea class="massage-bt" placeholder="Massage" rows="5" id="comment" name="message"></textarea required>
                        </div>
                        <div class="send_btn">
                           <button name="submit" style="padding-left: 20px; padding-right: 20px;font-size:25px;background-color:red;border-radius:20px;color:white;">Send</button>
                        </div>
                        </form>
